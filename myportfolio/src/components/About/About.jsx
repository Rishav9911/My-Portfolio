...
function About() {
  ...
  return (
    ...
    <motion.div variants={textVariants}  initial="initial" animate={inView ? "animate" : "initial"} className='aboutBox'>
     ...
     <motion.div className="aboutMe" variants={textVariants}> But as life is not all about just working, I try to enjoy life to the fullest,living one day at a time . My favourite leisure activity is <span className='white'>Sketching</span> ✍🏻 and binge-watching <span className='white'>Anime</span>. </motion.div>
     </motion.div>

     <motion.div className='aboutBox'  initial="initial" animate={inView ? "animate" : "initial"} variants={textVariants}>
     <motion.div className="aboutMe" variants={textVariants}> I'm always open to connecting  with fellow tech enthusiasts, industry professionals, and mentors. Feel free to connect with me through my Social Media handles. Let's explore opportunities to learn and grow together.🚀</motion.div>
     </motion.div>
