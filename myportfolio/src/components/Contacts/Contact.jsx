...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_wtcohr6', 'template_7kekm7d', formRef.current, {
        publicKey: 'lBTVvEsBlvdmON7Rb',
      })
      .then(
        () => {
          setSuccess(true)
